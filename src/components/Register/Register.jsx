  ...
  const handleGoogleSignin = () => {
    signInWithPopup(auth, googleProvider)
      .then((result) => {
        ...
        fetch("https://smart-deals-server-alpha.vercel.app/users", {
          method: "POST",
          headers: {
        ...
        if (additionalUserInfo?.isNewUser) {
          ...
          toast.info(
            "This email is already registered. You've been logged in!"
          );
        }
        ...
        <div className="card-body">
          ...
          <form onSubmit={handleRegister}>
            <fieldset className="fieldset relative">
              ...
              <button
                type="submit"
                className="btn btn-neutral bg-violet-600 border-violet-700 mt-8 "
              >
                Register
              </button>
